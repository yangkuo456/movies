...
if ( $.fn.dataTable.Api ) {
	...
	Api.regist( 'scroller()', function () {
		return this;
	} );

	Api.regist( 'scroller().rowToPixels()', function (rowIdx, intParse, virtual ) {
	...
	Api.regist( 'scroller().pixelsToRow()', function (pixels, intParse, virtual ) {
		var ctx = this.context;
	...
	Api.regist( 'scroller().scrollToRow()', function (row, ani ) {
	...
	Api.regist( 'scroller().measure()', function (redraw ) {
		this.iterator( 'table', function ( ctx ) {
			if ( ctx.oScroller ) {
